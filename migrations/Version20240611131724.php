 ...
 */
final class Version20240611131724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurant_bookings (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, prefered_group_number INT NOT NULL, allergies VARCHAR(255) DEFAULT NULL, date VARCHAR(255) NOT NULL, hour_selected_day VARCHAR(255) DEFAULT NULL, hour_selected_night VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(30) DEFAULT NULL, alias VARCHAR(180) NOT NULL, INDEX IDX_5A20F2DA9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE restaurant_places (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, active_date VARCHAR(255) NOT NULL, active_hour VARCHAR(255) NOT NULL, number_of_submit INT NOT NULL, number_of_places_max INT NOT NULL, UNIQUE INDEX UNIQ_F3193A416A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
