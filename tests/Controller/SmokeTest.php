...
class SmokeTest extends WebTestCase
{
    ...
    public function testIfBookingJsRouteIsSuccessfulWithTheRightData(): void
    {
        ...
        $client->request('POST', '/bookJS', [], [], [
            ...
            "alias" => "Test",
            "date" => "2024-05-31", // changer de date pour le test le cas échéant
        ...
        $this->assertEquals(200, $statusCode); // créer les fixtures Restaurant_Places et Rule pour faire marcher le test
    }
}
